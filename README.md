...
Osprey® is a free, open-source game server management panel built with PHP, React, and Go. Designed with security
in mind, Osprey runs all game servers in isolated Docker containers while exposing a beautiful and intuitive
UI to end users.
...
I would like to extend my sincere thanks to the following sponsors for helping fund Osprey's development.
...
Osprey supports a wide variety of games by utilizing Docker containers to isolate each instance. This gives
